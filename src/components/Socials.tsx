...
export default function Socials() {
  return (
    ...
    >
      ...
      <a href={"facebook.com"} className="w-5 h-5 rounded-full">
        <img src={Facebook} className="" alt="Facebook" />
      </a>
      <a href={"Twitter.com"} className="w-5 h-5 rounded-full">
        <img
          src={Twitter}
      ...
      <a href={"Pinstrest.com"} className="w-5 h-5 rounded-full">
